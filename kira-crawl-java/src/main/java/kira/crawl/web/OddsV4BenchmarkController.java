...
public class OddsV4BenchmarkController {
    ...
    public WebAsyncTask<OddsV4BenchmarkResponse> benchmark(
        ...
        task.onTimeout(() -> {
            throw new ResponseStatusException(HttpStatus.REQUEST_TIMEOUT, "Odds v4 benchmark timed out");
        });
        task.onError(() -> {
            throw new ResponseStatusException(HttpStatus.BAD_GATEWAY, "Odds v4 benchmark failed");
        });
        return task;
    }
}

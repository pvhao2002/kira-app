...
(
    ...
    open_hdc_line           varchar(25)  null,
    open_ou_line            varchar(25)  null,
    open_corner_line        varchar(25)  null,
    prematch_corner_line    varchar(25)  null,
    ...
    goal_str_pick           varchar(100) null,
    ...
    actual_ft_goal_str      varchar(10)  null,
    result_hdc              enum ('WIN', 'LOSE', 'VOID', 'NONE') null,
    result_ou               enum ('WIN', 'LOSE', 'VOID', 'NONE') null,
    ...
    index idx_event_prediction_version_result_hdc (prediction_version_id, result_hdc, settled_at),
    index idx_event_prediction_version_result_ou (prediction_version_id, result_ou, settled_at),

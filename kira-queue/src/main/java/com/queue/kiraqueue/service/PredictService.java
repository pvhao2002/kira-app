...
import com.queue.kiraqueue.dto.PredictDTO;
import com.queue.kiraqueue.dto.PredictDetail;
import com.queue.kiraqueue.dto.PredictStats;
...
public class PredictService {
    ...
    private static final String SQL_GET_EVENT_PREDICT = """
              ...
              WHERE TRUE
                ...
                AND (e.last_hdc IS NOT NULL OR e.last_hdc <> '')
                AND (e.last_ou IS NOT NULL OR e.last_ou <> '')
                AND (e.last_home_odds IS NOT NULL OR e.last_home_odds <> '')
                AND (e.last_under_odds IS NOT NULL OR e.last_under_odds <> '')
            """;
    ...
    public void predict(String eventId) {
        try {
            var eventToPredict = jdbcTemplate.query(
                    SQL_GET_EVENT_PREDICT,

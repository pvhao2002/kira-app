...
/** FIFA country-code lookup generated from the FIFA column in https://raw.githubusercontent.com/datasets/country-codes/master/data/country-codes.csv. */
public final class CountryCodeShortUtil {

    private static final String COUNTRY_CODE_DATA = """
            a rap xe ut=KSA
            abw=ARU
            ad=AND
            ae=UAE
    ...
    private static final Map<String, String> COUNTRY_CODE_BY_NAME = Arrays.stream(COUNTRY_CODE_DATA.strip().split("\n"))
            .map(line -> line.split("=", 2))
            .collect(Collectors.toUnmodifiableMap(parts -> parts[0], parts -> parts[1]));

    private CountryCodeShortUtil() {
    }
    ...
    public static String toAlpha3(String country) {
        ...
        return COUNTRY_CODE_BY_NAME.get(normalize(country));
    }

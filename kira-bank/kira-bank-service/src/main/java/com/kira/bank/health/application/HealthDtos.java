...
public final class HealthDtos {
    ...
    public record Profile(@NotNull @DecimalMin("80") @DecimalMax("250") Double heightCm,
                          ...
                          @NotNull @Size(max = 2000) String foodPreferences,
                          @NotNull @Size(max = 1000) String allergies,
                          @NotNull @Size(max = 1000) String avoidedFoods, @Min(0) @Max(240) int preparationMinutes,
                          @NotNull @Size(max = 1000) String exerciseExperience,
                          @NotNull @Size(max = 1000) String equipment,
                          @NotNull @Size(max = 1000) String availability,
                          @NotNull @Size(max = 2000) String movementRestrictions) {
    }
    ...
    public record Workout(@NotBlank @Pattern(regexp = "[A-Fa-f0-9-]{36}") String id,
                          ...
                          @DecimalMin("0") @DecimalMax("10000") Double calories,
    ...
    public record Summary(LocalDate date, Double bmi, Double restingEstimate, double eatenCalories,
                          ...
                          Double netCalories, String targetSource, boolean provisional, Long steps,

...
public interface CatalogMapper {
 BankDto toDto(Bank bank); MccDto toDto(Mcc mcc);
 @Mapping(target="bankId",source="bank.id") @Mapping(target="bankName",source="bank.name") CardDto toDto(CardCatalog card);
}

...
public class AiProviderAccount extends AuditedEntity {
    ...
    @Column(name = "ai_cooldown_until")
    private Instant cooldownUntil;
    @Column(name = "ai_last_error_code")
    private String lastErrorCode;
    @Column(name = "ai_last_error_at")
    private Instant lastErrorAt;
    @Column(name = "ai_last_tested_at")
    private Instant lastTestedAt;
    @Column(name = "ai_last_success_at")
    ...
    @Column(name = "r2_bucket_name")
    private String r2BucketName;
    @Column(name = "r2_public_url", length = 500)
    private String r2PublicUrl;
    @Column(name = "r2_primary", nullable = false)
    private boolean r2Primary;
    @Enumerated(EnumType.STRING)
    @Column(name = "r2_health_status", nullable = false, length = 30)
    private AiProviderAccountStatus r2HealthStatus;
    @Column(name = "r2_last_error_code")
    private String r2LastErrorCode;
    @Column(name = "r2_last_error_at")
    private Instant r2LastErrorAt;
    @Column(name = "r2_last_tested_at")
    private Instant r2LastTestedAt;
    @Column(name = "r2_last_success_at")
    private Instant r2LastSuccessAt;
}

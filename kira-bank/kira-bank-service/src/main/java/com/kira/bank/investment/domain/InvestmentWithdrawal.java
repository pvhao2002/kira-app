...
@Setter
@Entity
@Table(name = "investment_withdrawals")
public class InvestmentWithdrawal extends AuditedEntity {
    private Long userId, investmentAccountId;
    private Instant requestedDate;
    private BigDecimal requestedAmount, withdrawalFee, expectedNetAmount, actualNetAmount;
    private String destinationAccount, referenceNumber;

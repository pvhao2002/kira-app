...
public final class LodgingDtos {
    ...
    public record ListingRequest(@NotBlank @Size(max = 500) String address,
                                 @NotNull @PositiveOrZero BigDecimal rentPrice,
    ...
    public record ReferenceLocationRequest(@NotBlank @Size(max = 150) String name,
    ...
    public record DistanceResponse(Long referenceLocationId, String name, String address, Long distanceMeters,
    ...
    public record ListingResponse(Long id, String address, String formattedAddress, BigDecimal rentPrice,
                                  FeeRequest electricity, FeeRequest water, FeeRequest service, FeeRequest parking,
                                  String facebookUrl, String phone, String videoUrl, String note,
                                  LodgingStatus geocodeStatus,
                                  String geocodeError, OwnerResponse owner, boolean canEdit, boolean canDelete,
                                  long version,
                                  List<ImageResponse> images, List<DistanceResponse> distances,
    ...
    public record ReviewResponse(Long userId, String fullName, LodgingReviewStatus status, String reason,
                                 Instant updatedAt) {
    }

    public record ReferenceLocationResponse(Long id, String name, String address, String formattedAddress,
                                            LodgingStatus geocodeStatus,

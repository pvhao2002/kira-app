...
public final class CatalogDtos {
    ...
    public record BankDto(Long id, String code, String name, String shortName, String logoUrl, String website,
                          String hotline, String brandColor, String description) {
    }

...
export const vietnameseTranslations: Record<TranslationKey, string> = {
  ...
  ,'route.financeReport': 'Báo cáo đầu tư & ngân hàng'
  ,'shell.groupReports': 'BÁO CÁO'
  ,'shell.financeReport': 'Đầu tư & ngân hàng'
  ,'financeReport.eyebrow': 'Báo cáo tổng hợp'
  ,'financeReport.title': 'Báo cáo đầu tư & ngân hàng'
  ,'financeReport.description': 'Dư nợ tín dụng hiện tại theo ngân hàng cùng dòng tiền đầu tư trong khoảng thời gian đã chọn.'
  ,'financeReport.refresh': 'Làm mới'
  ,'financeReport.from': 'Từ ngày'
  ,'financeReport.to': 'Đến ngày'
  ,'financeReport.quickRange': 'Khoảng nhanh'
  ,'financeReport.apply': 'Áp dụng'
  ,'financeReport.rangeInvalid': 'Chọn khoảng thời gian hợp lệ, tối đa 365 ngày.'
  ,'financeReport.loading': 'Đang tải…'
  ,'financeReport.error': 'Không thể tải phần này.'
  ,'financeReport.retry': 'Thử lại'
  ,'financeReport.bankEyebrow': 'Hiện trạng'
  ,'financeReport.bankSection': 'Ngân hàng & tín dụng'
  ,'financeReport.openBankDashboard': 'Mở bảng tín dụng →'
  ,'financeReport.bank': 'Ngân hàng'
  ,'financeReport.cards': 'Số thẻ'
  ,'financeReport.creditLimit': 'Hạn mức'
  ,'financeReport.statementDebt': 'Dư nợ sao kê'
  ,'financeReport.currentBalance': 'Dư nợ hiện tại'
  ,'financeReport.availableCredit': 'Hạn mức khả dụng'
  ,'financeReport.utilization': 'Tỷ lệ sử dụng'
  ,'financeReport.noBanks': 'Chưa có dữ liệu ngân hàng.'
  ,'financeReport.investmentSection': 'Dòng tiền đầu tư'
  ,'financeReport.openInvestmentStatistics': 'Mở thống kê →'
  ,'financeReport.currency': 'Loại tiền'
  ,'financeReport.currencyHint': 'Mỗi loại tiền được báo cáo riêng, không cộng gộp.'
  ,'financeReport.deposits': 'Nạp'
  ,'financeReport.withdrawals': 'Rút'
  ,'financeReport.bonuses': 'Thưởng'
  ,'financeReport.net': 'Ròng'
  ,'financeReport.transactions': 'Giao dịch'
  ,'financeReport.account': 'Tài khoản'
  ,'financeReport.statusLabel': 'Trạng thái'
  ,'financeReport.noAccounts': 'Không có tài khoản đầu tư trong khoảng này.'
  ,'financeReport.noFlow': 'Không có hoạt động đầu tư trong khoảng này.'
};

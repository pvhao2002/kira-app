export const englishTranslations = {
  ...
  'investmentTransactions.sections': 'Investment transaction sections',
  'investmentTransactions.tabImport': 'Import & review AI',
  'investmentTransactions.tabHistory': 'Transaction history',
...
export const vietnameseTranslations: Record<TranslationKey, string> = {
  ...
  'investmentTransactions.sections': 'Các phần giao dịch đầu tư',
  'investmentTransactions.tabImport': 'Nhập và duyệt AI',
  'investmentTransactions.tabHistory': 'Lịch sử giao dịch',

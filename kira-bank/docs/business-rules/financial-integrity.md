...
- Sửa `card_transactions` (PUT) không đổi `dedup_key` nên nhập lại cùng sao kê vẫn bỏ qua dòng đã có, và không bao giờ sửa số tổng/payment của statement. Quy tắc cửa hàng chỉ điền MCC, không tự đổi giao dịch đã có MCC hoặc đã gán nhóm.

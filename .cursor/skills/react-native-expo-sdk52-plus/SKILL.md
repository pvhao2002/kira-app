---
name: react-native-expo-sdk52-plus
description: "Guides Expo SDK 52+ and React Native 0.76 through 0.82+ upgrades: New Architecture defaults and mandatory 0.82+ behavior, Hermes-only Expo Go, React 19 propTypes removal and forwardRef changes, Swift AppDelegate migration, Metro log forwarding and Chrome debugger removals, deep import restrictions, Android edge-to-edge, React Native DevTools, Reanimated v3 versus v4, expo-file-system and expo-av migration timelines, and common Fabric or TurboModule errors. Use when upgrading or debugging Expo or React Native, Expo prebuild for iOS or Android, expo-router, SDK 54 or 55 preparation, Hermes, or New Architecture compatibility."
